            ...
            <?php foreach( $allcourses as $course) :?>
              ...
              <div class="card course-card">
                ...
                <figure class="card-banner">
                  <img src="data:image/jpeg;base64,<?php echo base64_encode( $course['photo_cover'])?>" width="370" height="248" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta wrapper">
                    ...
                    <p class="title-sm">
                      ...
                      <span class="span"> <?php echo $course["description"] ?> </span>
