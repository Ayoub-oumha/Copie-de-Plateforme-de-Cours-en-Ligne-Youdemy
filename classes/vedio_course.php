...
class Vedio extends CourseManagementt {
    private $videoURL ;
    private $type ;
    public function __construct($videoURL, $type ,$title, $description, $teacher_id, $category_id, $tags, $thumbnail)
    {
    ...
    public function addCourse()
    {
        ...
        try {
            ...
            $query = "INSERT INTO courses (title, description, photo_cover, vedio, content_type , category_id, teacher_id, created_at) 
            ...
            $stmt->bindParam(':content', $this->videoURL );
